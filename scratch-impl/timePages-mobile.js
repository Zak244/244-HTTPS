...
function printResults() {
    ...
    for (var site in results) {
        ...
        var HTTP_line = site+" HTTP " +msToStr(HTTP_data["0"])+" "+msToStr(HTTP_data["1"])+" "+msToStr(HTTP_data["2"])+" "+msToStr(HTTP_data["3"])+" ";
        ...
        var HTTPS_line = site+" HTTPS " +msToStr(HTTPS_data["0"])+" "+msToStr(HTTPS_data["1"])+" "+msToStr(HTTPS_data["2"])+" "+msToStr(HTTPS_data["3"])+" ";
